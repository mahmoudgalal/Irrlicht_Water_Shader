...
#define NWAVES 2
Wave wave[NWAVES] = {
	{ 0.50, 0.9, 2.5, float2(-0.3, 0.9) },
	{ 0.60, 1.1, 1.3, float2(0.3, 0.3) }	
};
...
OceanVertOut OceanVS(AppData IN,
    ...
    // The following cause error "x3025: global variables are implicitly constant, enable compatibility mode to allow modification"
